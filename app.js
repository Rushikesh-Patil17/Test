/* 
    Use command 'npm install' to add all 'node_modules' if not exist.
    It will resolve all the dependencies in 'package.json' and installs all
    the required modules.
    Note: Usually node_modules directory is included in 'gitignore'.
*/
...
app.get("/posts/:postId", function(req, res) {
    ...
    Article.findOne({_id: postId}, function(err, foundArticle) {
        if (!foundArticle) {
            res.redirect("No Such Article found!");
        } else {
            console.log("Found!");
            res.render("post", {postData: foundArticle});
        }
    });
});
